...
const DiamondIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 3h12l4 6-10 13L2 9Z"/><path d="M11 3 8 9l4 13"/><path d="M12 22 16 9l-3-6"/></svg>
);
    ...
    <div className="min-h-screen bg-[#e6e0d4] text-[#3a3532] font-sans selection:bg-[#3a3532] selection:text-[#e6e0d4]">
      ...
      <section className="relative w-full h-screen min-h-[600px] flex items-center">
        ...
        <header className="absolute top-0 w-full z-50 py-8 px-8 md:px-12 flex justify-between items-center">
          ...
          <div className="w-[60%] flex items-center justify-between pr-4 md:pr-12">
            <div className="text-xl md:text-2xl font-black tracking-tighter text-[#3a3532] uppercase">Kitchen</div>
            <nav className="hidden md:flex gap-8 text-[11px] font-bold text-[#3a3532] uppercase tracking-widest">
              <a href="#" className="hover:opacity-60 transition-opacity">Equipment</a>
              <a href="#" className="hover:opacity-60 transition-opacity">Kitchenware</a>
              <a href="#" className="hover:opacity-60 transition-opacity">Chef's Tools</a>
            </nav>
          </div>
          {/* Right (over dark) */}
          <div className="w-[40%] flex justify-end items-center gap-6 pl-4 md:pl-12">
             <button className="text-[#e6e0d4] hover:opacity-70 transition-opacity"><CartIcon /></button>
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-8 md:px-12 flex flex-col md:flex-row justify-between items-center h-full pt-20">
          ...
          <div className="w-full md:w-[40%] bg-white/10 backdrop-blur-xl border border-white/10 p-10 rounded-2xl shadow-2xl text-[#e6e0d4] relative overflow-hidden group">
             ...
             <h2 className="text-3xl font-bold mb-4 uppercase tracking-tight relative z-10">Elevate Your Prep</h2>
             <p className="text-sm text-[#e6e0d4]/80 mb-8 leading-relaxed relative z-10">
               Experience the intersection of high-end culinary gear and premium aesthetics. Precision engineered. Infinite durability.
             </p>
      ...
      <main className="pb-24">
        ...
        <section className="max-w-[1400px] mx-auto px-8 md:px-12 mt-32">
          <h2 className="text-3xl font-black mb-10 uppercase tracking-tighter">Featured Categories</h2>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-auto lg:h-[600px]">
            ...
            <div className="lg:col-span-2 relative rounded-2xl overflow-hidden bg-[#d5ccb7] group cursor-pointer shadow-lg min-h-[400px]">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-[#3a3532]/10 bg-[#cfc5b0] transition-transform duration-700 group-hover:scale-105">
                 <span className="text-5xl font-black uppercase tracking-tighter">Pro Cutlery</span>
              </div>
              <div className="absolute bottom-10 left-10 z-20 text-[#e6e0d4] transform transition-transform duration-500 group-hover:translate-y-[-10px]">
                <span className="bg-[#e6e0d4] text-[#3a3532] text-xs font-bold px-3 py-1 mb-4 inline-block uppercase tracking-widest rounded-sm">New Arrival</span>
                <h3 className="text-4xl font-black uppercase tracking-tight">Chef's Knives Collection</h3>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex-1 relative rounded-2xl overflow-hidden bg-[#3a3532] group cursor-pointer shadow-lg min-h-[250px]">
                 ...
                 <div className="absolute inset-0 flex items-center justify-center opacity-30 transition-transform duration-700 group-hover:scale-105">
                   <span className="text-4xl font-black text-[#e6e0d4] uppercase tracking-tighter">Cookware</span>
                 </div>
                 <div className="absolute bottom-8 left-8 z-20 text-[#e6e0d4]">
                   <h3 className="text-2xl font-bold uppercase tracking-tight">Cast Iron Series</h3>
                 </div>
              </div>
              <div className="flex-1 relative rounded-2xl overflow-hidden bg-white group cursor-pointer shadow-lg min-h-[250px]">
                 ...
                 <div className="absolute inset-0 flex items-center justify-center opacity-10 bg-[#f4f1eb] transition-transform duration-700 group-hover:scale-105">
                   <span className="text-4xl font-black text-[#3a3532] uppercase tracking-tighter">Essentials</span>
                 </div>
                 <div className="absolute bottom-8 left-8 z-20 text-[#3a3532]">
                   <h3 className="text-2xl font-bold uppercase tracking-tight">Prep Tools</h3>
                 </div>
              </div>
            </div>
          </div>
        ...
        <section className="max-w-[1400px] mx-auto px-8 md:px-12 mt-32">
          <div className="flex justify-between items-end mb-10">
            ...
            <a href="#" className="text-xs font-bold uppercase tracking-widest text-[#8b7a66] hover:text-[#3a3532] transition-colors">View All</a>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm hover:shadow-xl transition-shadow duration-300 group cursor-pointer">
              <div className="aspect-square bg-[#f4f1eb] rounded-xl mb-6 flex items-center justify-center overflow-hidden relative">
                <div className="w-full h-full bg-[#e6e0d4]/50 group-hover:scale-105 transition-transform duration-500 flex items-center justify-center">
                   <span className="text-[#3a3532]/20 font-black text-xl uppercase tracking-widest">Image</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm hover:shadow-xl transition-shadow duration-300 group cursor-pointer relative">
              <span className="absolute top-8 left-8 bg-[#cc5555] text-white text-[10px] font-bold px-2 py-1 rounded-sm z-10 uppercase tracking-widest">Sale</span>
              <div className="aspect-square bg-[#f4f1eb] rounded-xl mb-6 flex items-center justify-center overflow-hidden relative">
                <div className="w-full h-full bg-[#e6e0d4]/50 group-hover:scale-105 transition-transform duration-500 flex items-center justify-center">
                   <span className="text-[#3a3532]/20 font-black text-xl uppercase tracking-widest">Image</span>
                </div>
              ...
              <p className="font-bold mb-6 flex items-center gap-3">
                ...
                <span className="line-through text-[#3a3532]/40 text-sm">$110</span>
              </p>
              <button className="w-full py-3 border-2 border-[#3a3532] rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-[#3a3532] hover:text-[#e6e0d4] transition-colors flex items-center justify-center gap-2">
                <CartIcon /> Add to Cart
              </button>
        ...
        <section className="bg-[#3a3532] text-[#e6e0d4] mt-32 py-24 px-8 md:px-12 rounded-t-[3rem] mx-4 md:mx-12 lg:mx-20 shadow-2xl">
          <div className="max-w-[1200px] mx-auto">
            <h2 className="text-3xl font-black text-center mb-16 uppercase tracking-tighter">Why Kitchen?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16 text-center">
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-black mb-4 uppercase tracking-widest">Fast Shipping</h3>
                <p className="text-[#e6e0d4]/60 leading-relaxed text-sm font-medium">
                  Global expedited delivery ensures you get your gear before the next meal prep.
                </p>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-20 h-20 bg-[#e6e0d4]/5 rounded-2xl flex items-center justify-center mb-8 transform -rotate-3 hover:rotate-0 transition-transform duration-300 border border-[#e6e0d4]/10">
                ...
                <h3 className="text-xl font-black mb-4 uppercase tracking-widest">Elite Quality</h3>
                <p className="text-[#e6e0d4]/60 leading-relaxed text-sm font-medium">
                  Uncompromising materials and construction. We only sell what we trust in our own kitchens.
                </p>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-20 h-20 bg-[#e6e0d4]/5 rounded-2xl flex items-center justify-center mb-8 transform rotate-3 hover:rotate-0 transition-transform duration-300 border border-[#e6e0d4]/10">
                ...
                <h3 className="text-xl font-black mb-4 uppercase tracking-widest">Secure Checkout</h3>
                <p className="text-[#e6e0d4]/60 leading-relaxed text-sm font-medium">
                  Encrypted, lightning-fast transactions to secure your premium culinary tools.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-[#2a2624] text-[#e6e0d4]/50 py-16 px-8 md:px-12">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="text-3xl font-black tracking-tighter text-[#e6e0d4] uppercase">Kitchen</div>
          <div className="flex flex-wrap justify-center gap-8 text-xs font-bold uppercase tracking-widest">
            <a href="#" className="hover:text-[#e6e0d4] transition-colors">Privacy Policy</a>
            <a href="#" className="hover:text-[#e6e0d4] transition-colors">Terms of Service</a>
            <a href="#" className="hover:text-[#e6e0d4] transition-colors">Shipping Info</a>
            <a href="#" className="hover:text-[#e6e0d4] transition-colors">Returns</a>
            <a href="#" className="hover:text-[#e6e0d4] transition-colors">Contact Us</a>
          </div>
          <div className="text-[10px] font-bold tracking-widest uppercase">
            &copy; 2026 KITCHEN SUPPLY.<br/> ALL RIGHTS RESERVED.
          </div>
        </div>
      </footer>
    </div>
