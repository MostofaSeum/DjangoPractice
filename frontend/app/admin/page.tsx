            ...
            <div className="flex flex-col gap-6">
              ...
              {productSubTab === "reviews" && (
                <div className="bg-secondary text-foreground p-12 rounded-3xl border border-foreground/10 shadow-sm flex flex-col items-center justify-center text-center gap-3">
                  ...
                  <p className="text-xs text-foreground/60 max-w-sm">
                    Customer product reviews and ratings will appear here. No
                  ...
                  >
                    ...
                    {(() => {
                      const shortWords = productForm.short_description.trim()
                        ? productForm.short_description.trim().split(/\s+/)
                            .length
                        : 0;
                          ...
                          <div className="space-y-3">
                            ...
                            {newProductPhotoPreviews.length < 5 && (
                              ...
                              >
                                ...
                                <span>
                                  Add More Photos (
                                  {5 - newProductPhotoPreviews.length} left)
                                </span>
                              </button>
                            )}
                          </div>
                      ...
                      <div className="space-y-3 pt-4 border-t border-foreground/10">
                        ...
                        {newProductVariants.length > 0 ? (
                          ...
                          <div className="p-3.5 rounded-xl border border-foreground/10 bg-primary/5 dark:bg-primary/20 text-[10px] opacity-60 text-center">
                            No variants added yet. This product will use its
                            base price (৳
                            {Number(
              ...
              {productSubTab === "edit" && (
                <div className="max-w-3xl mx-auto w-full bg-secondary text-foreground p-8 md:p-10 rounded-3xl border border-foreground/10 shadow-sm transition-colors duration-300">
                  ...
                  {/* Product Search & Selection (Search Bar with Instant Click Suggestions, No Native Dropdown) */}
                  <div className="mb-6 p-5 rounded-2xl bg-primary/5 dark:bg-primary/20 border border-foreground/10 flex flex-col gap-3">
                    ...
                    {(() => {
                      ...
                      const filteredEditProducts = promoProductsCatalog.filter(
                        (p) => {
                    ...
                    {editingProductId && (() => {
                      const selectedProd = promoProductsCatalog.find((p) => p.id === editingProductId);
                      return (
                  ...
                  {editingProductId ? (
                    ...
                    <div className="p-10 border-2 border-dashed border-foreground/15 rounded-3xl text-center flex flex-col items-center justify-center gap-2">
                      ...
                      <p className="text-[11px] text-foreground/50">
                        Please choose a product from the dropdown above or click
                        on any product from &ldquo;All Products&rdquo;.
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="w-full bg-secondary text-foreground p-8 rounded-3xl border border-foreground/10 shadow-sm overflow-x-auto transition-colors duration-300">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 pb-2 border-b border-foreground/10">
                    ...
                    <ProductSearchBar
                      ...
                      onSelectProduct={(prod) =>
                        handleSelectProduct(prod as any)
                      }
                      onSearchSubmit={(q) => {
                  ...
                  {Math.ceil(totalProductsCount / 9) > 1 && (
                    <div className="flex justify-between items-center mt-6 pt-4 border-t border-foreground/10 text-xs font-bold">
                      <button
                        onClick={() =>
                          setProdPage((prev) => Math.max(prev - 1, 1))
                        }
                        disabled={prodPage === 1}
                      ...
                      <button
                        onClick={() =>
                          setProdPage((prev) =>
                            Math.min(
                              prev + 1,
                              Math.ceil(totalProductsCount / 9),
                            ),
                          )
                        }
                  ...
                  <p>
                    ...
                    {selectedOrderDetails.delivery_charge !== undefined && (
                      <span className="ml-2 px-2 py-0.5 rounded-md bg-secondary border border-foreground/10 text-[10px] font-bold">
                        Delivery Fee: ৳
                        {Number(selectedOrderDetails.delivery_charge).toFixed(
                          2,
                        )}
                      </span>
                    )}
                ...
                <div className="flex justify-between items-center pb-4 border-b border-foreground/10 mb-6">
                  <div>
                    <h3 className="text-lg font-black uppercase tracking-tight">
                      ...
                      {customerHistoryModal.customerId}
                    </h3>
                    <span className="text-[10px] font-bold opacity-60 uppercase tracking-wider">
                            ...
                            {ord.items.map((it) => (
                              ...
                              >
                                ...
                                <span className="font-bold">
                                  ৳
                                  {(
                                    it.quantity * Number(it.unit_price)
                                  ).toFixed(2)}
                                </span>
                              </div>
                            ))}
                              ...
                              {(() => {
                                ...
                                return (
                                  <>
                                    ...
                                    {matches.map((prod) => {
                                      const isSelected =
                                        promoSelectedProductIds.includes(
                                          prod.id,
                                        );
                                      const isOnSale =
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) =>
                          setCouponDiscountPercent(e.target.value)
                        }
                        placeholder="e.g. 20"
                        className="w-full bg-background border border-foreground/15 rounded-xl px-4 pr-20 py-3 text-xs font-bold text-foreground outline-none focus:ring-2 focus:ring-accent [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none shadow-inner"
                      />
                    ...
                    <div className="relative">
                      <div className="flex justify-between items-center mb-2">
                        <label className="block text-[10px] font-extrabold uppercase tracking-wider opacity-70">
                          ...
                          {promoProductsCatalog.length} available)
                        </label>
                        {couponSelectedProductIds.length > 0 && (
                          <button
                            type="button"
                            ...
                            {(() => {
                              ...
                              return (
                                <>
                                  ...
                                  {matches.map((prod) => {
                                    const isSelected =
                                      couponSelectedProductIds.includes(
                                        prod.id,
                                      );
                                    return (
                                      <div
            ...
            (() => {
              const hasDeliveryChanges =
                ...
                deliverySettings.is_active !==
                  initialDeliverySettings.is_active;
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-6 border-b border-foreground/10">
                      ...
                      <div className="flex items-center gap-3 w-full sm:w-auto">
                        ...
                        <button
                          type="button"
                          disabled={
                            savingDeliverySettings || !hasDeliveryChanges
                          }
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="p-6 rounded-3xl bg-primary/5 dark:bg-primary/30 border border-foreground/10 space-y-4">
                          ...
                          <div className="space-y-2 pt-2">
                            ...
                            <p className="text-[10px] opacity-50 font-medium">
                              Amount added to customer order when Inside Dhaka
                              is chosen (e.g. 60 tk).
                            </p>
                          </div>
                        ...
                        <div className="p-6 rounded-3xl bg-primary/5 dark:bg-primary/30 border border-foreground/10 space-y-4">
                          ...
                          <div className="space-y-2 pt-2">
                            ...
                            <p className="text-[10px] opacity-50 font-medium">
                              Amount added to customer order when Outside Dhaka
                              is chosen (e.g. 130 tk).
                            </p>
                          </div>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <div className="lg:col-span-7 space-y-4">
                          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-2 border-b border-foreground/10">
                            <h4 className="text-xs font-black uppercase tracking-wider text-foreground">
                              Existing Delivery Offers (
                              {deliveryRulesList.length})
                            </h4>
                            <input
                              type="text"
