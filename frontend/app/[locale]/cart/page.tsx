                  ...
                  >
                    ...
                    <div className="flex items-center justify-between sm:justify-end w-full sm:w-auto gap-8">
                      ...
                      <button
                        ...
                        className="opacity-50 hover:opacity-100 hover:text-red-500 transition-colors p-2 cursor-pointer"
                        title={locale === "bn" ? "কার্ট থেকে সরান" : "Remove item"}
                        type="button"
                      >
                        <img src="/icons/trash.png" alt="Delete" className="w-5 h-5 object-contain dark:invert" />
                      </button>
                    </div>
                  </div>
                );
